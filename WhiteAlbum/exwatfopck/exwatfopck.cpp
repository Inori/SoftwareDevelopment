...
// This tool extracts and rebuild *.pck archives used by WHITE ALBUMÅ|í‘ÇÁÇÍÇÈì~ÇÃëzÇ¢èoÅ| (PS3).
...
int main(int argc, char** argv)
{
	...
	if (argc < 2)
	{
		fprintf(stderr, "exwatfopck v1.1 by asmodean & modified by ∏£“Ù(Fuyin)\n\n");
